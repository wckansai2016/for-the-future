...
(0, _jquery2.default)(function () {
	...
	(0, _jquery2.default)('.nav_btn').click(function () {
		(0, _jquery2.default)('.overlay').toggle();
		(0, _jquery2.default)('#gnav').toggleClass('nav_open');
	});

	(0, _jquery2.default)('.overlay').click(function () {
		(0, _jquery2.default)('.overlay').toggle();
		(0, _jquery2.default)('#gnav').removeClass('nav_open');
	});
});
